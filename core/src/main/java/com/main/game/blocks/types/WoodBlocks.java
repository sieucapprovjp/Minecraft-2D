...
public class WoodBlocks {
    public static class OakLogBlock extends AbstractBlock {
        public OakLogBlock(int x, int y) { super(x, y, "oak_log", false, true, 2.0f); }
    ...
    public static class OakPlanksBlock extends AbstractBlock {
        public OakPlanksBlock(int x, int y) { super(x, y, "oak_planks", false, true, 2.0f); }
    ...
    public static class OakLeavesBlock extends AbstractBlock {
        public OakLeavesBlock(int x, int y) { super(x, y, "oak_leaves", false, true, 0.2f); }
