...
public class WoodBlocks {
    public static class OakLogBlock extends AbstractBlock {
        public OakLogBlock(int x, int y) { super(x, y, "oak_log", true, true, 2.0f); }
    ...
    public static class OakPlanksBlock extends AbstractBlock {
        public OakPlanksBlock(int x, int y) { super(x, y, "oak_planks", true, true, 2.0f); }
    ...
    public static class OakLeavesBlock extends AbstractBlock {
        public OakLeavesBlock(int x, int y) { super(x, y, "oak_leaves", true, true, 0.2f); }
