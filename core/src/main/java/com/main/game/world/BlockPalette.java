...
public final class BlockPalette {
    ...
    static {
        fallbackRegion = loadRegion("libgdx.png");
        STONE   = loadRegionOrFallback("mvp/tiles/stone.png");
        ...
        PLANKS  = loadRegionOrFallback("mvp/tiles/woodenplanks.png");

        // TODO(VHUNG-BLOCKS): thay bằng dirt texture thật khi team chốt asset.
        // Current MVP asset is JPEG at assets/mvp/tiles/dirt.jpg.
