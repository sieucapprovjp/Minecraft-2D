...
public final class ToolRegistry {
    ...
    static {
        ...
        register("wood_axe", ToolType.AXE, ToolMaterial.WOOD, "tools/wood/wood_axe", 1.5f, 4, 30);
        ...
        register("stone_axe", ToolType.AXE, ToolMaterial.STONE, "tools/stone/stone_axe", 2.0f, 5, 45);
        ...
        register("copper_axe", ToolType.AXE, ToolMaterial.COPPER, "tools/copper/copper_axe", 2.5f, 5, 60);
        ...
        register("iron_axe", ToolType.AXE, ToolMaterial.IRON, "tools/iron/iron_axe", 3.0f, 6, 75);
        ...
        register("gold_axe", ToolType.AXE, ToolMaterial.GOLD, "tools/gold/gold_axe", 3.5f, 5, 24);
        ...
        register("diamond_axe", ToolType.AXE, ToolMaterial.DIAMOND, "tools/diamond/diamond_axe", 4.0f, 7, 110);
        ...
        register("netherite_axe", ToolType.AXE, ToolMaterial.NETHERITE, "tools/netherite/netherite_axe", 4.5f, 8, 140);
    ...
    private static void register(String itemId, ToolType type, ToolMaterial material,
                                 String textureName, float miningMultiplier, int attackDamage,
                                 int maxDurability) {
        TOOLS.put(itemId, new ToolDefinition(itemId, type, material, textureName, miningMultiplier, attackDamage, maxDurability));
    }
